...
If you need to look at the examples, the best example for dated script is
`wikimedia_commons.py`, for not dated: `science_museum.py`.
...
def _extract_item_data(media_data, counters):
    """
